...
public class CommunityController {
    ...
    public PageResult search(@RequestParam Map searchMap){
...
//        return new PageResult(true,200,"查询小区列表成功",null,10l);
    }

    @RequestMapping("/add")
    public Result add(@RequestParam Community community){
        Boolean add = communityService.add(community);
        return new Result(true,StatusCode.OK,MessageConstant.COMMUNITY_ADD_SUCCESS);
//        return new Result(true,2000,"新增 小区列表成功",null);
