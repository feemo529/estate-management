...
MySQL - 8.0.19 : Database - heima-estate
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`heima-estate` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `tb_building` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='楼栋表';

/*Data for the table `tb_building` */

insert  into `tb_building`(`id`,`community_name`,`community_id`,`name`,`total_households`,`description`,`create_time`,`update_time`) values (1,'百花小区',3,'C栋',32,'无','2022-05-08 17:13:12','2022-05-08 19:19:08'),(2,'百花小区',3,'A栋',51,'无','2022-05-08 19:23:30','2022-05-08 19:23:30'),(3,'鲸鱼小区',4,'A栋',54,'无','2022-05-08 19:16:49','2022-05-08 19:16:49'),(4,'金鱼华府',4,'B栋',14,'无','2022-05-08 19:16:49',NULL),(5,'金玉化区',4,'A栋',22,'无','2022-05-08 19:52:22',NULL);
...
CREATE TABLE `tb_charge_detail` (
  ...
  `telephone` int DEFAULT NULL COMMENT '承办人联系电话',
...
CREATE TABLE `tb_community` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1123134 DEFAULT CHARSET=utf8 COMMENT='小区表';

/*Data for the table `tb_community` */

insert  into `tb_community`(`id`,`code`,`name`,`address`,`area`,`total_buildings`,`total_households`,`greening_rate`,`thumbnail`,`developer`,`estate_company`,`create_time`,`update_time`,`status`) values (1,'HX19960101001','化纤小区','历城区花园路5号',22000,66,2432,30,'/fileupload/huaxian.jpg','济南齐鲁化纤集团有限责任公司','上海新长宁集团新华物业有限公司','2020-12-13 09:12:04','2020-12-13 09:26:12','1'),(2,'DH19960101002','东风小区','历城区花园路6号',777777,50,2222,40,'/images/dongfeng.jpg','济南齐鲁化纤集团有限责任公司','上海新长宁集团新华物业有限公司','2020-12-15 09:24:42','2020-12-13 09:26:14','1'),(3,'BH19960101003','百花小区','历城区花园路7号',44444,88,3000,50,'/fileupload/baihua.JPG','济南齐鲁化纤集团有限责任公司','上海新长宁集团新华物业有限公司','2020-12-16 09:24:42','2020-12-13 09:24:42','1'),(4,'JYHF20160101001','金域华府','齐鲁软件园',66666,70,2195,50,'/fileupload/jinyuhuafu.jpg','万达地产集团','万科物业','2020-12-14 19:29:48',NULL,'0'),(1123132,'HX19960101002','鲸鱼小区',NULL,192,34,23,53,'/fileupload/ecf66142-ae31-4549-8cb1-bb052ef32c5d.jpg','济南齐鲁化纤集团有限责任公司','济南齐鲁化纤集团有限责任公司','2022-05-08 19:05:15','2022-05-08 20:01:55',NULL),(1123133,'DH19960101004','鲫鱼小区',NULL,43,32,11,23,'/fileupload/fd0a84d8-f201-4ff8-89b7-4ad3a6fca38f.jpg','上海新长宁集团新华物业有限公司','上海新长宁集团新华物业有限公司','2022-05-08 19:58:07','2022-05-08 20:02:11','0');
...
insert  into `tb_estate_manager`(`id`,`community_name`,`community_id`,`login_name`,`name`,`password`,`telephone`,`email`,`role_id`,`create_time`,`update_time`) values (1,'化纤小区',1,'15900000000','张三','123456',2147483647,'123@163.com',0,'2020-12-14 10:17:49','2020-12-14 10:17:49'),(2,'百花小区',3,'15911111111','李四','123456',2147483647,'456@163.com',0,'2020-12-14 10:17:55','2020-12-14 10:17:55'),(3,'东风小区',2,'15922222222','王五','123456',2147483647,'789@163.com',0,'2020-12-14 10:18:03','2020-12-14 10:18:03');
...
CREATE TABLE `tb_house` (
  ...
  `telephone` int DEFAULT NULL COMMENT '联系方式',
